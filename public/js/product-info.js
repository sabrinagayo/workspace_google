...
function carouselImage(array){
	...
	for(i = 0; i < array.length; i++){
		...
		htmlContentToAppend2 = `
		<img class="border w-100" src="static/`+image+`">
		`;
		if (i>0) {
			htmlContentToAppend3 = `
	        ...
	        <div class="carousel-item">
	          <img class="d-block w-100" src="static/`+image+`" alt="Second slide">
	        </div>
			`;
		}else{
			htmlContentToAppend3 = `
	        ...
	        <div class="carousel-item active">
	          <img class="d-block w-100" src="static/`+activeImage+`" alt="Second slide">
	        </div>
			`;
		}
			...
			<div class="productList">
		        <a href="product-info.html?nombre=` + relatedProduct.name + `" class="text-dark productInfoLink">
		          	<div class="view overlay">
		            	<img class="card-img-top" src="static/`+relatedProduct.imgSrc+`"
